-- Szablon zapytania sprzedaży Mag WAPRO (Clarion date + POZYCJA_DOKUMENTU_MAGAZYNOWEGO).
-- Placeholder __SKU__ podstawia sync-wapro-stock-server.ps1
-- Ilość i netto: SUM ze znakiem (korekty ujemne).
...
INNER JOIN dbo.ARTYKUL a WITH (NOLOCK)
  ON a.ID_ARTYKULU = pd.ID_ARTYKULU
